define(['module', 'exports'], function (module, exports) {
	...
	(function (global, factory) {
		(typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.frosting = factory();
	})(undefined, function () {
		'use strict';
		...
		var Frosting = function () {
			...
			_createClass(Frosting, [{
				...
				value: function computeColors(palette) {
					...
					var base = tinycolor(palette.base);
					var light = palette.light ? tinycolor(palette.light) : base.clone().lighten(8.7 * this.skewLighten);
					var lighter = palette.lighter ? tinycolor(palette.lighter) : light.clone().lighten(8 * this.skewLighten);
					var lighterer = palette.lighterer ? tinycolor(palette.lighterer) : lighter.clone().lighten(10 * this.skewLighten);
					var lightest = palette.lightest ? tinycolor(palette.lightest) : lighterer.clone().lighten(10 * this.skewLighten);
					var lightestest = palette.lightestest ? tinycolor(palette.lightestest) : lightest.clone().lighten(9.3 * this.skewLighten);
					var dark = palette.dark ? tinycolor(palette.dark) : base.clone().darken(4.35 * this.skewDarken);
					var darker = palette.darker ? tinycolor(palette.darker) : dark.clone().darken(7 * this.skewDarken);
					var darkerer = palette.darkerer ? tinycolor(palette.darkerer) : darker.clone().darken(6 * this.skewDarken);
					var darkest = palette.darkest ? tinycolor(palette.darkest) : darkerer.clone().darken(11 * this.skewDarken);
					var darkestest = palette.darkestest ? tinycolor(palette.darkestest) : darkest.clone().darken(6 * this.skewDarken);
